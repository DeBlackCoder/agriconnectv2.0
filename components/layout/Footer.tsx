        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <span className="text-xl sm:text-2xl font-bold text-white">AgriConnect</span>
            </Link>
            <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 leading-relaxed">
              Connecting farmers directly with buyers through innovative technology. 
              Fresh produce, fair prices, sustainable future.
            </p>
            <div className="flex items-center gap-3 sm:gap-4">
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-800 hover:bg-green-600 flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
              <li>
                <Link href="/products?category=Vegetables" className="text-gray-400 hover:text-green-400 transition-colors">
                  Vegetables
                </Link>
              </li>
              <li>
                <Link href="/products?category=Fruits" className="text-gray-400 hover:text-green-400 transition-colors">
                  Fruits
                </Link>
              </li>
              <li>
                <Link href="/products?category=Grains" className="text-gray-400 hover:text-green-400 transition-colors">
                  Grains & Cereals
                </Link>
              </li>
              <li>
                <Link href="/products?isOrganic=true" className="text-gray-400 hover:text-green-400 transition-colors">
                  Organic Products
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 mb-6 sm:mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 text-sm sm:text-base">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <a href="mailto:hello@agriconnect.ng" className="text-gray-400 hover:text-green-400 transition-colors break-all">
                hello@agriconnect.ng
              </a>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" />
              <a href="tel:+2348012345678" className="text-gray-400 hover:text-green-400 transition-colors">
                +234 801 234 5678
              </a>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:hello@agriconnect.ng" className="text-gray-400 hover:text-green-400 transition-colors">
                hello@agriconnect.ng
              </a>
            </div>
            <div className="flex items-center gap-3">
