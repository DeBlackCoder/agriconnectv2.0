      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
          <div>
            ...
            <Link href="/about">
              <Button className="bg-gray-900 hover:bg-gray-800 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg text-sm sm:text-base">
                Discover More
              </Button>
            </Link>
          </div>
            ...
            <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
              <div className="text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-lg">
                  <div className="w-0 h-0 border-l-[16px] sm:border-l-[20px] border-l-green-600 border-t-[10px] sm:border-t-[12px] border-t-transparent border-b-[10px] sm:border-b-[12px] border-b-transparent ml-1"></div>
                </div>
                <p className="text-white font-medium text-sm sm:text-base">Watch Our Story</p>
              </div>
            </div>
          </div>
        </div>
