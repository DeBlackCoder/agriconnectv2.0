...
export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-br from-green-50 to-blue-50 pt-32 pb-20 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/products">
              <Button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg text-lg font-semibold flex items-center gap-2">
                Browse Products <ArrowRight className="w-5 h-5" />
              </Button>
            </Link>
            <Link href="/farmers">
              <Button variant="outline" className="border-orange-500 text-orange-500 hover:bg-orange-50 px-8 py-4 rounded-lg text-lg font-semibold">
                For Farmers
              </Button>
            </Link>
          </div>
