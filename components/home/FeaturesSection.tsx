    ...
    <section className="py-12 sm:py-20 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-center">
          <div className="relative h-[300px] sm:h-[500px] rounded-2xl overflow-hidden shadow-xl">
            <img 
          ...
          <div>
            ...
            <Link href="/how-it-works">
              <Button className="w-full sm:w-auto bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded-lg text-sm sm:text-base">
                Discover More
              </Button>
            </Link>
          </div>
